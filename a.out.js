...
function _js_init_image_data(p,o,w,h){ var arr = new Uint8ClampedArray(Module.wasmMemory.buffer, p, o); window.$imageData = new ImageData(arr, w, h); }
function _js_render_image_data(){ window.$ctx.putImageData(window.$imageData, 0, 0); }
...
Module['wasmTableSize'] = 220;

Module['wasmMaxTableSize'] = 220;
...
var real____em_js__js_init_image_data = asm["___em_js__js_init_image_data"]; asm["___em_js__js_init_image_data"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__js_init_image_data.apply(null, arguments);
};

var real____em_js__js_render_image_data = asm["___em_js__js_render_image_data"]; asm["___em_js__js_render_image_data"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__js_render_image_data.apply(null, arguments);
};
...
var ___em_js__js_init_image_data = Module["___em_js__js_init_image_data"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__js_init_image_data"].apply(null, arguments) };
var ___em_js__js_render_image_data = Module["___em_js__js_render_image_data"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__js_render_image_data"].apply(null, arguments) };
